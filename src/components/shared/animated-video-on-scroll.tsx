...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-[#CAFF33] bg-gray-950/10 px-4 py-2 shadow-[0px_4px_24px_#CAFF33] transition-colors hover:bg-slate-950/50",
        className,
      )}
      {...props}
    />
