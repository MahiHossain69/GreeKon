  ...
  return (
    <section className="pb-12 bg-white">
      <div className="container mx-auto flex flex-col items-center text-center">
        <h2 className="font-tanker text-[#1A2E26] text-3xl md:text-4xl  uppercase tracking-tight ">
          {heading}
        </h2>
      </div>
          ...
          >
            <CarouselContent className="ml-0">
              {logos.map((logo) => (
                ...
                >
                  <div className="mx-8 flex shrink-0 items-center justify-center grayscale hover:grayscale-0 transition-all duration-300">
                    <div>
                      <img
                        src={logo.image}
